...
class AudioDownloader:
    ...
    async def download_voice_file(self, voice_url: str, chat_id: str, message_id: str) -> Tuple[
        Optional[str], Optional[VoiceError]]:
        """
        Скачивает голосовой файл по URL
        ...
        try:
            ...
            async with httpx.AsyncClient(timeout=self.timeout) as client:
                ...
                async with client.stream("GET", voice_url, headers=headers) as response:
            ...
            logger.error(f"[AudioDownloader] Таймаут при скачивании файла: {voice_url}")
            error = VoiceError(
