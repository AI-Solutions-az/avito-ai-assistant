...
class Settings:
    ...
    AUTO_ESCALATION_ENABLED: bool = False  # Автоматический вызов оператора по ключевым словам
...
TELEGRAM_ESCALATION_THREAD_ID = os.getenv("TELEGRAM_ESCALATION_THREAD_ID")
